...
- Fix issue in which schemas were generated record types with `additionalProperties` set to `true` when the record type represented the shape of an entity type that also had tags. This was in error and causes the generated schema to be malformed.
