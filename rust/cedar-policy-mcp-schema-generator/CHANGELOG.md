...
- Added new configuration option `encode_as_number` which forces all `"number"` and `"float"` typeds MCP tool parameters to be encoded as a `decimal` in the generated Cedar schema.
